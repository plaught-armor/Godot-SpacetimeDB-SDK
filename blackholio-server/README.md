...
2. `probe_vector3`, `probe_error` and `probe_params` procedures in `src/lib.rs`, appended at the end of the file.
...
is tested against (2.2.0–2.10.0) — verified end to end against a 2.10.0 server, so
