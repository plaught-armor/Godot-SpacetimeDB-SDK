...
GDScript SDK for SpacetimeDB. Godot 4.7 + SpacetimeDB 2.7.0 (requires 2.2.0+ — v3 BSATN protocol, schema v10; tested 2.2.0–2.7.0). The legacy WS v2 sub-protocol was dropped in SDK 2.0; for servers below 2.2.0 use an SDK 1.x release.
