...
func _generate_table_gdscript(schema: SpacetimeParsedSchema, table_def: Dictionary) -> String:
	...
	content += ("\ton_insert(_emit_inserted)\n" +
...
func _generate_db_gdscript(module_name: String, schema: SpacetimeParsedSchema) -> String:
	...
	for table_name in tables:
		var table_type: String = tables[table_name]
...
func _generate_types_gdscript(module_name: String, schema: SpacetimeParsedSchema) -> String:
	...
	var content: String = AUTOGENERATED_COMMENT + class_name_line
