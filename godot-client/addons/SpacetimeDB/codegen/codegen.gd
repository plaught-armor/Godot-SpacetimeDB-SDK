...
func _scan_project_enums() -> Dictionary:
	...
	for cls in global_classes:
		...
		if cls_path.begins_with(SpacetimePlugin.BINDINGS_PATH): continue
		if cls_path.begins_with("res://addons/"): continue
	...
	for prop in ProjectSettings.get_property_list():
		...
		if not prop_name.begins_with("autoload/"): continue
		...
		if resolved_path.begins_with(SpacetimePlugin.BINDINGS_PATH): continue
		if resolved_path.begins_with("res://addons/"): continue
