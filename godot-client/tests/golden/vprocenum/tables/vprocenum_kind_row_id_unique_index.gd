...
class_name VprocenumKindRowIdUniqueIndex extends _ModuleTableUniqueIndex

var _cache: Dictionary[int, VprocenumKindRow] = {}
...
func find(col_val: int) -> VprocenumKindRow:
