...
@tool
class_name VsubmodModuleClient extends SpacetimeDBClient

var reducers: VsubmodModuleReducers
var procedures: VsubmodModuleProcedures
var db: VsubmodModuleDb

func _init() -> void:
	module_name = "Vsubmod"
	name = "VsubmodModule"
	reducers = preload('user://golden_gen/vsubmod/module_vsubmod_reducers.gd').new(self)
	procedures = preload('user://golden_gen/vsubmod/module_vsubmod_procedures.gd').new(self)

func _init_db(p_local_db: LocalDatabase) -> void:
	db = preload('user://golden_gen/vsubmod/module_vsubmod_db.gd').new(p_local_db)
