...
class_name VsubmodLibLibDataIdUniqueIndex extends _ModuleTableUniqueIndex

var _cache: Dictionary[int, VsubmodLibLibData] = {}
...
func find(col_val: int) -> VsubmodLibLibData:
